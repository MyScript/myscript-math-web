...
import { addListener, removeListener } from '../polymer/lib/utils/gestures.js';
import { beforeNextRender } from '../polymer/lib/utils/render-status.js';
...
*/
class MyScriptCommonElement extends GestureEventListeners(mixinBehaviors([IronResizableBehavior], Element)) {
  static get template() {
    return `
