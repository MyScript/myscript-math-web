  ...
  return function b(a, c, d) {
        ...
        var g = function (a) {
          ...
          var h = function (a, b, c) {
            ...
            var g,
                ...
                n,
                o,
                p = Math.max(a.documentElement.scrollWidth, a.body.clientWidth),
          ...
          var l = function (a, b) {
            ...
            if (h) for (c = "<div" + h[1] + "></div>", i.documentElement.innerHTML = c, f = i.querySelector("div"), d = 0; d < f.attributes.length; d++) g = f.attributes[d], a.documentElement.setAttribute(g.name, g.value);
          };
      ...
      (function (b) {
        !function (e) {
          ...
          if (u = {
            ...
            if (s) s.exports = u;else for (v in u) u.hasOwnProperty(v) && (r[v] = u[v]);
          } else e.punycode = u;
        }(this);
      ...
      b.exports = function () {
        ...
        function d(b) {
          ...
          function j() {
            ...
            if (a = R, b = k(), b !== r) {
              if (c = [], d = o(), d !== r) for (; d !== r;) c.push(d), d = o();else c = v;
          ...
          function n() {
            var a, c, d;
            if (a = R, c = [], M.test(b.charAt(R)) ? (d = b.charAt(R), R++) : (d = r, 0 === X && e(N)), d !== r) for (; d !== r;) c.push(d), M.test(b.charAt(R)) ? (d = b.charAt(R), R++) : (d = r, 0 === X && e(N));else c = v;
    ...
    16: [function (a, b, c) {
      ...
      d.CSSStyleRule = function () {
        ...
        for (var b, c, e, f = 0, g = "selector", h = f, i = "", j = {
          ...
          case "}":
            if ("value" === g) k.style.setProperty(c, i.trim(), l), l = "", i = "";else {
              if ("name" === g) break;
              i += e;
            }
            g = "selector";
      ...
      d.CSSValueExpression = function (a, b) {
        ...
        if ("/" === d || "*" === d) {
          var e,
              f,
              g = b;
          if ("/" === d ? f = "\n" : "*" === d && (f = "*/"), e = a.indexOf(f, g + 1 + 1), -1 !== e) return e = e + f.length - 1, c = a.substring(b, e + 1), {
            idx: e,
            text: c
          };
    ...
    27: [function (a, b, c) {
      ...
      c.rulesForCssText = function (a) {
        return (f || g) && d.parse ? d.parse(a).cssRules : e(a);
    ...
    30: [function (a, b, c) {
      ...
      var d = a("./util"),
          e = function (a, b) {
        var c = a.attributes.src ? a.attributes.src.value : null,
            e = d.getDocumentBaseUrl(a.ownerDocument),
            f = d.clone(b);
        return !f.baseUrl && e && (f.baseUrl = e), d.getDataURIForImageURL(c, f).then(function (a) {
          ...
          f = function (a) {
        return a.filter(function (a) {
          var b = a.attributes.src ? a.attributes.src.value : null;
    ...
    36: [function (a, b, c) {
      ...
      var d = function (a) {
        ...
        for (b = 0; b < f.length; b++) if (c = f[b].exec(e)) return c[1];
      },
          h = function (a) {
        var b;
