...
import builtinMacros from "./macros.js";
  ...
  nextToken() {
    for (;;) {
      ...
      if (expansion.numArgs) {
        const args = [];
        let i; // obtain arguments, either single token or balanced {…} group
        ...
        for (i = 0; i < expansion.numArgs; ++i) {
          ...
          if (startOfArg.text === "{") {
            ...
            throw new ParseError("End of input expecting macro argument", topToken);
          } else {
            args[i] = [startOfArg];
          }
