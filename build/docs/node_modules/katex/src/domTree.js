 ...
 */
import unicodeRegexes from "./unicodeRegexes.js";
...
class span {
  ...
  toNode() {
    const span = document.createElement("span"); // Apply the class
...
class documentFragment {
  ...
  toNode() {
    // Create a fragment
    const frag = document.createDocumentFragment(); // Append the children
