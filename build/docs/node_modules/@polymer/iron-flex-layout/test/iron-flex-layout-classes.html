...
document.body.appendChild($_documentContainer.content);</script>
    <script type="module">import '../iron-flex-layout-classes.js';
...
suite('basic layout', function () {
  ...
  test('layout-horizontal', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 50, 0, 300), 'container position ok'); // |c1| |c2| |c3|
  ...
  test('layout-horizontal-reverse', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 50, 0, 300), 'container position ok'); //     |c3| |c2| |c1|
  ...
  test('layout-vertical', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 150, 0, 300), 'container position ok'); // vertically, |c1| |c2| |c3|
  ...
  test('layout-vertical-reverse', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 150, 0, 300), 'container position ok'); // vertically, |c3| |c2| |c1|
  ...
  test('layout-wrap', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 100, 0, 120), 'container position ok'); // |c1| |c2|
    // |c3|
  ...
  test('layout-wrap-reverse', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 100, 0, 100), 'container position ok'); //      |c3|
    // |c2| |c1|
...
suite('flex', function () {
  ...
  test('layout-flex child in a vertical layout', function () {
    ...
    c2.classList.add('flex');
    assert.isTrue(positionEquals(container, 0, 300, 0, 300), 'container position ok'); // vertically, |c1| |    c2    | |c3|
...
suite('justification', function () {
  ...
  test('layout-around-justified', function () {
    ...
    assert.isTrue(positionEquals(container, 0, 50, 0, 300), 'container position ok');
    var spacing = (300 - 50 * 3) / 6; // Every child gets `spacing` on its left and right side.
