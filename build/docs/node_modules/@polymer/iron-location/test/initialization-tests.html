...
suite('<iron-location>\'s initialization', function () {
  ...
  var cases = ['default-before', 'attached-before', 'ready-before', // TODO: These tests are failing with Polymer 2 (#95).
  // 'default-below',
  // 'default-after',
  // 'attached-below',
  // 'attached-after',
  ...
  // 'ready-after',
  // 'ready-container',
  'default-above', 'attached-above', 'ready-above', 'default-container', 'attached-container'];
