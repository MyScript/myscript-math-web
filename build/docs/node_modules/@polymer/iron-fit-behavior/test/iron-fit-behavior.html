...
--><html><head>
  ...
  <body>
    ...
    <script type="module">import './test-fit.js';
...
suite('manual positioning', function () {
  ...
  test('inline positioned element is not re-positioned', function () {
    ...
    var rect = el.getBoundingClientRect(); // need to measure document.body here because mocha sets a min-width on
...
suite('fit to element', function () {
  ...
  test('positioned element fits in another element', function () {
    var constrain = document.querySelector('.constrain'); // element's positionTarget is `body`, and fitInto is `constrain`.
...
suite('horizontal/vertical align', function () {
  ...
  test('intersects works', function () {
    ...
    assert.isFalse(intersects(base, {
      top: 1,
      bottom: 2,
      left: 0,
      right: 1
  ...
  suite('when verticalAlign is top', function () {
    ...
    test('element is kept in viewport', function () {
      el.verticalAlign = 'top'; // Make it go out of screen
  ...
  suite('when verticalAlign is bottom', function () {
    ...
    test('element is kept in viewport', function () {
      el.verticalAlign = 'bottom'; // Make it go out of screen
  ...
  suite('when verticalAlign is middle', function () {
    ...
    test('element is kept in viewport', function () {
      el.verticalAlign = 'middle'; // Make it go out of screen
  ...
  suite('when horizontalAlign is left', function () {
    ...
    test('element is kept in viewport', function () {
      el.horizontalAlign = 'left'; // Make it go out of screen.
  ...
  suite('when horizontalAlign is right', function () {
    ...
    test('element is kept in viewport', function () {
      el.horizontalAlign = 'right'; // Make it go out of screen.
  ...
  suite('when horizontalAlign is center', function () {
    ...
    test('element is kept in viewport', function () {
      el.horizontalAlign = 'center'; // Make it go out of screen.
  ...
  suite('prefer horizontal overlap to vertical overlap', function () {
    setup(function () {
      el.noOverlap = true;
      el.dynamicAlign = true; // Make space around the positionTarget.
