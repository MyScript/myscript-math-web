...
--><html><head>
  ...
  <script type="module" src="./simple-overlay.js"></script>
...
<body unresolved="" class="centered">
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>An element with <code>IronOverlayBehavior</code> can be opened, closed, toggled.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>Use <code>with-backdrop</code> to add a backdrop to your overlay. Tabbing will be trapped within the overlay.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>Use <code>restore-focus-on-close</code> to return the focus to the element that opened the overlay when it gets closed.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>The child with <code>autofocus</code> gets focused when opening the overlay.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>Multiple overlays can be opened.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>Use <code>always-on-top</code> to keep the overlay on top of others.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>An element with <code>IronOverlayBehavior</code> can be scrollable or contain scrollable content.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>e-overlay.js';
// .scrollable is the element that determines the size of the overlay.
scrolling2.sizingTarget = scrolling2.querySelector('.scrollable');
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>Use <code>allow-click-through</code> to allow click events to be handled by overlays below the top overlay.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
...
document.body.appendChild($_documentContainer.content);</script>
  ...
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<h3>Use <code>scroll-action</code> to lock, refit or cancel an overlay on scroll.</h3>`;
document.body.appendChild($_documentContainer.content);</script>
  <script type="module">const $_documentContainer = document.createElement('template');
$_documentContainer.innerHTML = `<demo-snippet>
    <template>
