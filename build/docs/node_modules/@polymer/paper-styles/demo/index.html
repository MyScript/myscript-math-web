...
--><html><head>
    ...
    <script type="module" src="../shadow.js"></script>
    <script type="module" src="../typography.js"></script>
    <script type="module" src="../default-theme.js"></script>
    <script type="module" src="../element-styles/paper-item-styles.js"></script>
    <script type="module" src="../element-styles/paper-material-styles.js"></script>
...
document.body.appendChild($_documentContainer.content);</script></head>
