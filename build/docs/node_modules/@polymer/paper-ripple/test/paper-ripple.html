...
<body>
  ...
  <script type="module">import '../paper-ripple.js';
...
suite('<paper-ripple>', function () {
  ...
  suite('with the `center` attribute set to true', function () {
    ...
    test('ripples will center', function (done) {
      var waveContainerElement; // let's ask the browser what `translate3d(0px, 0px, 0)` will actually
      // look like
  ...
  suite('remove a paper ripple', function () {
    ...
    test('add and remove a paper-ripple', function (done) {
      ...
      dom(rippleContainer).appendChild(ripple); // NOTE: shadydom applies distribution asynchronously
    ...
    test('reuse a paper-ripple', function (done) {
      ...
      dom(document.body).appendChild(ripple); // NOTE: shadydom applies distribution asynchronously
      // for performance reasons webcomponents/shadydom#120
      // Flush to force distribution.
