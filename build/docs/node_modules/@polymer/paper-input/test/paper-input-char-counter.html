...
suite('basic', function () {
  ...
  test('character counter shows the value length with maxlength', function (done) {
    var container = fixture('counter-with-max'); // Need to wait a tick to stamp the char-counter.
  ...
  test('character counter shows the value length with maxlength', function (done) {
    var input = fixture('textarea-with-max'); // Need to wait a tick to stamp the char-counter.
  ...
  test('character counter counts new lines in textareas correctly', function (done) {
    ...
    input.value = 'foo\nbar'; // Need to wait a tick to stamp the char-counter.
