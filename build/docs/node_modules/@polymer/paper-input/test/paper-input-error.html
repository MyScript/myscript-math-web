...
suite('basic', function () {
  test('error message only appears when input is invalid', function (done) {
    var container = PolymerElement ? fixture('auto-validate-numbers-2') : fixture('auto-validate-numbers-1');
    var input = dom(container).querySelector('#i');
    var error = dom(container).querySelector('#e'); // Need to wait a tick to stamp the error message.
