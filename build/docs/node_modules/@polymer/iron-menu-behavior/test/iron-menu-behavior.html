...
--><html><head>
  ...
  <body>
    ...
    <script type="module">import './test-menu.js';
...
suite('menu a11y tests', function () {
  ...
  test('focusing on next item skips disabled items', function (done) {
    ...
    waitForIronItemsChanged(menu, function () {
      MockInteractions.focus(menu); // Wait for async focus
  ...
  test('focusing on item with multi-char, quick input', function (done) {
    ...
    waitForIronItemsChanged(menu, function () {
      ...
      Base.async(function () {
        // Key press 'u'
        MockInteractions.keyDownOn(menu, 85); // Key press 'g'
  ...
  test('focusing on item with multi-char ignoring modifier keys, quick input', function (done) {
    ...
    waitForIronItemsChanged(menu, function () {
      ...
      Base.async(function () {
        // Key press 'u'
        MockInteractions.keyDownOn(menu, 85); // Key press 'Alt', should be ignored.

        MockInteractions.keyDownOn(menu, 10); // Key press 'Caps Lock', should be ignored.

        MockInteractions.keyDownOn(menu, 20); // Key press 'Control', should be ignored.

        MockInteractions.keyDownOn(menu, 17); // Key press 'Num Lock', should be ignored.

        MockInteractions.keyDownOn(menu, 144); // Key press 'Scroll Lock', should be ignored.

        MockInteractions.keyDownOn(menu, 145); // Key press 'Shift', should be ignored.

        MockInteractions.keyDownOn(menu, 16); // Key press 'g'
  ...
  test('keyboard events should not bubble', function (done) {
    ...
    waitForIronItemsChanged(menu, function () {
      ...
      MockInteractions.keyDownOn(menu.firstElementChild, 38); // down

      MockInteractions.keyDownOn(menu.firstElementChild, 40); // esc
  ...
  test('`tabIndex` properties of all items are updated when items change', function (done) {
    ...
    waitForIronItemsChanged(menu, function () {
      ...
      menu.select(0);
      assertTabIndexCounts(menu.items, {
        '-1': 2,
        '0': 1
      });
      ...
      flush();
      menu.forceSynchronousItemUpdate(); // Async wait for `observeNodes`.
