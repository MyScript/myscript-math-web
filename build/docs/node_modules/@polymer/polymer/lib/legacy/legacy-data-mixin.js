...
const UndefinedArgumentError = class extends Error {
  constructor(message, arg) {
    super(message);
    this.arg = arg;
    this.name = this.constructor.name; // Affordances for ensuring instanceof works after babel ES5 compilation
...
export const LegacyDataMixin = dedupingMixin(superClass => {
  ...
  class LegacyDataMixin extends superClass {
    ...
    _marshalArgs(args, path, props) {
      const vals = super._marshalArgs(args, path, props); // Per legacy data rules, single-property observers (whether in `properties`
