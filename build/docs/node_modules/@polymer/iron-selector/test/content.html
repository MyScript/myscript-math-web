...
suite('content', function () {
  ...
  test('set selected', function () {
    // set selected
    s1.selected = 'item1'; // check selected class
  ...
  test('add item dynamically', function () {
    ...
    s1.selector.forceSynchronousItemUpdate(); // set selected

    s1.selected = 'item4'; // check items length

    assert.equal(s1.selector.items.length, 5); // check selected class
...
suite('content with selectable', function () {
  ...
  test('set selected', function () {
    // set selected
    s2.selected = 'item1'; // check selected class
  ...
  test('add item dynamically', function () {
    ...
    s2.selector.forceSynchronousItemUpdate(); // set selected

    s2.selected = 'item4'; // check items length

    assert.equal(s2.selector.items.length, 5); // check selected class
...
suite('content with dom-repeat', function () {
  ...
  test('supports repeated children', function () {
    ...
    s3.selector.forceSynchronousItemUpdate(); // check selected

    assert.equal(s3.selected, 'item0'); // check selected class

    assert.isTrue(s3.querySelector('#item0').classList.contains('iron-selected')); // set selected

    s3.selected = 'item2'; // check selected class
