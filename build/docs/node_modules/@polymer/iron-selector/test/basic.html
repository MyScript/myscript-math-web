...
suite('basic', function () {
  ...
  test('allows assignment to selected', function () {
    // set selected
    s2.selected = 'item4'; // check selected class

    assert.isTrue(s2.children[4].classList.contains('iron-selected')); // check item
  ...
  test('fire iron-select when selected is set', function () {
    ...
    s2.selected = 'item4'; // check iron-select event
  ...
  suite('items changing', function () {
    ...
    test('updates selected item', function (done) {
      ...
      expect(firstElementChild.classList.contains('iron-selected')).to.be.eql(true);
  ...
  suite('dynamic selector', function () {
    ...
    test('selects dynamically added child automatically', function (done) {
      ...
      selector.selected = '0';
      document.body.appendChild(selector); // Create and append a new item which should become selected.
