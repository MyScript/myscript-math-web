...
<body>
  ...
  <script type="module">import '../paper-progress.js';
...
suite('basic features', function () {
  ...
  test('set value', function (done) {
    ...
    asyncPlatformFlush(function () {
      assert.equal(progress.value, 50); // test clamp value
  ...
  test('The <paper-progress> only has a "aria-valuenow" attribute when ' + '`indeterminate` is true.', function () {
    progress.min = 0;
    progress.max = 10;
    progress.value = 5.1;
