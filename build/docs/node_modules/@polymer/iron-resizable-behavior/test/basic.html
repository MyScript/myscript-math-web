...
-->
  ...
  <script type="module">import '../iron-resizable-behavior.js';
...
suite('iron-resizable-behavior', function () {
  ...
  suite('x-resizer-parent', function () {
    test('notify resizables from window', function () {
      var listeners = [ListenForResize(testEl.$.parent), ListenForResize(testEl.$.child1a), ListenForResize(testEl.$.child1b), ListenForResize(testEl.$.shadow1c.$.resizable), ListenForResize(testEl.$.shadow1d.$.resizable)];
    ...
    test('detach parent then notify window', function (done) {
      var listeners = [ListenForResize(testEl.$.parent, false), ListenForResize(testEl.$.child1a, false), ListenForResize(testEl.$.child1b, false), ListenForResize(testEl.$.shadow1c.$.resizable, false), ListenForResize(testEl.$.shadow1d.$.resizable, false)];
  ...
  suite('x-resizer-parent-filtered', function () {
    test('notify resizables from window', function () {
      var listeners = [ListenForResize(testEl.$.parentFiltered), ListenForResize(testEl.$.child2a), ListenForResize(testEl.$.child2b, false), ListenForResize(testEl.$.shadow2c.$.resizable, false), ListenForResize(testEl.$.shadow2d.$.resizable, false)];
    ...
    test('detach resizables then notify parent', function () {
      var listeners = [ListenForResize(testEl.$.parentFiltered), ListenForResize(testEl.$.child2a, false), ListenForResize(testEl.$.child2b, false), ListenForResize(testEl.$.shadow2c.$.resizable, false), ListenForResize(testEl.$.shadow2d.$.resizable)];
