...
--><html><head>
  ...
  <body>
    ...
    <script type="module">import '../iron-autogrow-textarea.js';
...
suite('focus/blur events', function () {
  ...
  test('focus/blur events fired on host element', function (done) {
    ...
    input.addEventListener('focus', function () {
      nFocusEvents += 1; // setTimeout to wait for potentially more, erroneous events
    ...
    input.addEventListener('blur', function () {
      nBlurEvents += 1; // setTimeout to wait for potentially more, erroneous events
