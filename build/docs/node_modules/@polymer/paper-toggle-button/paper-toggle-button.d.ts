 ...
 */
interface PaperToggleButtonElement extends PaperCheckedElementBehavior, LegacyElementMixin, HTMLElement {
  attached(): void;
...
export {PaperToggleButtonElement};
