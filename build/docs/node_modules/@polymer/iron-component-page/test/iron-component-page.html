...
describe('<iron-component-page>', function () {
  ...
  beforeEach(function (done) {
    ...
    server.respondWith('GET', 'analysis.json', [200, {
      'Content-Type': 'application/json'
    }, JSON.stringify(descriptor)]);
    page = fixture('basic'); // Just a flush should be ok, but Safari 9 consistently needs more.
  ...
  it('fetches default descriptor name and renders from it', function () {
    var view = page.$$('iron-doc-viewer').$$('iron-doc-namespace').$$('iron-doc-summary');
