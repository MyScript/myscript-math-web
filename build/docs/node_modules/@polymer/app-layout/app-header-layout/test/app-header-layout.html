...
suite('basic features', function () {
  ...
  test('fullbleed', function () {
    ...
    flush$0();
    assert.deepEqual(headerLayout.getBoundingClientRect(), headerLayout.offsetParent.getBoundingClientRect());
  });
...
suite('Scrolling region and fixed header', function () {
  ...
  test('Issue #406', function (done) {
    ...
    flush(function () {
      assert.equal(headerLayout.$.contentContainer.style.marginTop, header.offsetHeight + 'px');
      done();
    });
  });
});</script>
