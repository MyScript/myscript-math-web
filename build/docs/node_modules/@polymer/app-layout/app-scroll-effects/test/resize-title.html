...
suite('basic features', function () {
  ...
  test('effect outputs', function (done) {
    flush(function () {
      ...
      assert.isTrue(sameCSS(container.$.mainTitle, 'will-change: opacity; transform: translate(0px, 0px) scale3d(1, 1, 1); opacity: 1;'), 'main-title when progress = 0');
      ...
      assert.isTrue(sameCSS(container.$.mainTitle, 'will-change: opacity; transform: translate(50px, 50px) scale3d(1.5, 1.5, 1); opacity: 1;'), 'main-title when progress = 0.5');
      ...
      assert.isTrue(sameCSS(container.$.mainTitle, 'will-change: opacity; transform: translate(100px, 100px) scale3d(2, 2, 1); opacity: 0;'), 'main-title when progress = 1');
