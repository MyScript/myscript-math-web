...
suite('basic features', function () {
  ...
  test('effect outputs', function (done) {
    flush(function () {
      ...
      assert.isTrue(sameCSS(container.$.backgroundFrontLayer, 'will-change: opacity; transition-property: opacity; ' + 'transition-duration: 0.5s;'), 'backgroundFrontLayer when progress = 0');
      assert.isTrue(sameCSS(container.$.backgroundRearLayer, 'will-change: opacity; transition-property: opacity;' + 'transition-duration: 0.5s;'), 'backgroundRearLayer when progress = 0');
