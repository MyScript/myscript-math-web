...
suite('basic features', function () {
        ...
        window.setTimeout(function () {
          ...
          window.setTimeout(function () {
            ...
            window.setTimeout(function () {
              ...
              window.setTimeout(function () {
                assert.isFalse(drawer.opened);
                assert.equal(listenerSpy.callCount, 5, 'should fire after swiping beyond end state');
                done();
              }, 50);
            }, 50);
          }, 50);
  ...
  test('left drawer swiping', function (done) {
    ...
    afterNextRender(drawer, function () {
      ...
      drawer.fire('track', {
        state: 'track',
        dx: halfWidth + drawerWidth,
        ddx: drawerWidth
      });
      assertDrawerStyles(0, 1, 'styles are upper bounded'); // Simulate break of track events.
